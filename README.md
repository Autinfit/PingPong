...
- **_Import those images and assign them to the ball, the player and the computer picture box._**
- **_Display a custom ending message when the player or computer wins the game._**
